...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int start, int endInclusive, int step) {
        if (step == 0) {
            ...
            this.first = start;
            this.last = UProgressionUtilKt.m1215getProgressionLastElementNkh28Cs(start, endInclusive, step);
            this.step = step;
        } else {
    ...
    public String toString() {
        ...
        StringBuilder sb;
        if (this.step > 0) {
            sb = new StringBuilder().append(UInt.m163toStringimpl(this.first)).append("..").append(UInt.m163toStringimpl(this.last)).append(" step ");
            i = this.step;
        } else {
            sb = new StringBuilder().append(UInt.m163toStringimpl(this.first)).append(" downTo ").append(UInt.m163toStringimpl(this.last)).append(" step ");
            i = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final UIntProgression m1231fromClosedRangeNkh28Cs(int rangeStart, int rangeEnd, int step) {
