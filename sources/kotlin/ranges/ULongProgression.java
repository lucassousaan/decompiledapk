...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long start, long endInclusive, long step) {
        if (step == 0) {
            ...
            this.first = start;
            this.last = UProgressionUtilKt.m1214getProgressionLastElement7ftBX0g(start, endInclusive, step);
            this.step = step;
        } else {
    ...
    public final long m1235getFirstsVKNKU() {
        return this.first;
    }

    /* renamed from: getLast-s-VKNKU  reason: not valid java name */
    public final long m1236getLastsVKNKU() {
        return this.last;
    }
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return (((((int) ULong.m196constructorimpl(j ^ ULong.m196constructorimpl(j >>> 32))) * 31) + ((int) ULong.m196constructorimpl(j2 ^ ULong.m196constructorimpl(j2 >>> 32)))) * 31) + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        StringBuilder sb;
        if (this.step > 0) {
            sb = new StringBuilder().append(ULong.m241toStringimpl(this.first)).append("..").append(ULong.m241toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder().append(ULong.m241toStringimpl(this.first)).append(" downTo ").append(ULong.m241toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1237fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
