...
public final class UShortArray implements Collection<UShort>, KMappedMarker {
    ...
    public static short[] m354constructorimpl(short[] storage) {
        Intrinsics.checkNotNullParameter(storage, "storage");
        return storage;
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static short[] m353constructorimpl(int size) {
        return m354constructorimpl(new short[size]);
    }

    /* renamed from: get-Mh2AYeg  reason: not valid java name */
    public static final short m359getMh2AYeg(short[] $this, int index) {
        return UShort.m302constructorimpl($this[index]);
    }

    /* renamed from: set-01HTLdE  reason: not valid java name */
    public static final void m364set01HTLdE(short[] $this, int index, short value) {
        $this[index] = value;
    }

    /* renamed from: getSize-impl  reason: not valid java name */
    public static int m360getSizeimpl(short[] $this) {
        return $this.length;
    }

    /* renamed from: iterator-impl  reason: not valid java name */
    public static java.util.Iterator<UShort> m363iteratorimpl(short[] $this) {
    ...
    /* renamed from: contains-xj2QHRw  reason: not valid java name */
    public static boolean m355containsxj2QHRw(short[] $this, short element) {
        return ArraysKt.contains($this, element);
    }

    /* renamed from: containsAll-impl  reason: not valid java name */
    public static boolean m356containsAllimpl(short[] $this, Collection<UShort> elements) {
        Object it;
        ...
        for (Object element$iv : $this$all$iv) {
            if (!(element$iv instanceof UShort) || !ArraysKt.contains($this, ((UShort) element$iv).m351unboximpl())) {
                it = null;
                continue;
            } else {
                it = 1;
    ...
    public static boolean m362isEmptyimpl(short[] $this) {
