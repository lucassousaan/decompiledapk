...
public final class UByteArray implements Collection<UByte>, KMappedMarker {
    ...
    public static byte[] m94constructorimpl(byte[] storage) {
        Intrinsics.checkNotNullParameter(storage, "storage");
        return storage;
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static byte[] m93constructorimpl(int size) {
        return m94constructorimpl(new byte[size]);
    }

    /* renamed from: get-w2LRezQ  reason: not valid java name */
    public static final byte m99getw2LRezQ(byte[] $this, int index) {
        return UByte.m42constructorimpl($this[index]);
    }

    /* renamed from: set-VurrAj0  reason: not valid java name */
    public static final void m104setVurrAj0(byte[] $this, int index, byte value) {
        $this[index] = value;
    }

    /* renamed from: getSize-impl  reason: not valid java name */
    public static int m100getSizeimpl(byte[] $this) {
        return $this.length;
    }

    /* renamed from: iterator-impl  reason: not valid java name */
    public static java.util.Iterator<UByte> m103iteratorimpl(byte[] $this) {
    ...
    /* renamed from: contains-7apg3OU  reason: not valid java name */
    public static boolean m95contains7apg3OU(byte[] $this, byte element) {
        return ArraysKt.contains($this, element);
    }

    /* renamed from: containsAll-impl  reason: not valid java name */
    public static boolean m96containsAllimpl(byte[] $this, Collection<UByte> elements) {
        Object it;
        ...
        for (Object element$iv : $this$all$iv) {
            if (!(element$iv instanceof UByte) || !ArraysKt.contains($this, ((UByte) element$iv).m91unboximpl())) {
                it = null;
                continue;
            } else {
                it = 1;
    ...
    public static boolean m102isEmptyimpl(byte[] $this) {
