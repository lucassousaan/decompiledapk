...
public final class UIntArray implements Collection<UInt>, KMappedMarker {
    ...
    public static int[] m172constructorimpl(int[] storage) {
        Intrinsics.checkNotNullParameter(storage, "storage");
        return storage;
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int[] m171constructorimpl(int size) {
        return m172constructorimpl(new int[size]);
    }

    /* renamed from: get-pVg5ArA  reason: not valid java name */
    public static final int m177getpVg5ArA(int[] $this, int index) {
        return UInt.m118constructorimpl($this[index]);
    }

    /* renamed from: set-VXSXFK8  reason: not valid java name */
    public static final void m182setVXSXFK8(int[] $this, int index, int value) {
        $this[index] = value;
    }

    /* renamed from: getSize-impl  reason: not valid java name */
    public static int m178getSizeimpl(int[] $this) {
        return $this.length;
    }

    /* renamed from: iterator-impl  reason: not valid java name */
    public static java.util.Iterator<UInt> m181iteratorimpl(int[] $this) {
    ...
    /* renamed from: contains-WZ4Q5Ns  reason: not valid java name */
    public static boolean m173containsWZ4Q5Ns(int[] $this, int element) {
        return ArraysKt.contains($this, element);
    }

    /* renamed from: containsAll-impl  reason: not valid java name */
    public static boolean m174containsAllimpl(int[] $this, Collection<UInt> elements) {
        Object it;
        ...
        for (Object element$iv : $this$all$iv) {
            if (!(element$iv instanceof UInt) || !ArraysKt.contains($this, ((UInt) element$iv).m169unboximpl())) {
                it = null;
                continue;
            } else {
                it = 1;
    ...
    public static boolean m180isEmptyimpl(int[] $this) {
