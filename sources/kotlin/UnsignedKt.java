...
public final class UnsignedKt {
    ...
    public static final int m371uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m118constructorimpl((int) ((v1 & 4294967295L) / (4294967295L & v2)));
    }

    /* renamed from: uintRemainder-J1ME1BU  reason: not valid java name */
    public static final int m372uintRemainderJ1ME1BU(int v1, int v2) {
        return UInt.m118constructorimpl((int) ((v1 & 4294967295L) % (4294967295L & v2)));
    }

    /* renamed from: ulongDivide-eb3DHEI  reason: not valid java name */
    public static final long m373ulongDivideeb3DHEI(long v1, long v2) {
        long j = 0;
        if (v2 < 0) {
            ...
            return ULong.m196constructorimpl(v1 / v2);
        } else {
            int i = 1;
            long quotient = ((v1 >>> 1) / v2) << 1;
            long rem = v1 - (quotient * v2);
            if (ulongCompare(ULong.m196constructorimpl(rem), ULong.m196constructorimpl(v2)) < 0) {
                i = 0;
            }
            return ULong.m196constructorimpl(i + quotient);
        }
    }

    /* renamed from: ulongRemainder-eb3DHEI  reason: not valid java name */
    public static final long m374ulongRemaindereb3DHEI(long v1, long v2) {
        long j = 0;
        if (v2 < 0) {
            if (ulongCompare(v1, v2) < 0) {
                return v1;
            ...
            return ULong.m196constructorimpl(rem - j);
        }
    }
    ...
    public static final int doubleToUInt(double v) {
        if (!Double.isNaN(v) && v > uintToDouble(0)) {
            ...
            return v <= d ? UInt.m118constructorimpl((int) v) : UInt.m118constructorimpl(UInt.m118constructorimpl((int) (v - d)) + UInt.m118constructorimpl(Integer.MAX_VALUE));
        }
        return 0;
    }
    ...
    public static final long doubleToULong(double v) {
        if (!Double.isNaN(v) && v > ulongToDouble(0L)) {
            ...
            return v < ((double) Long.MAX_VALUE) ? ULong.m196constructorimpl((long) v) : ULong.m196constructorimpl(ULong.m196constructorimpl((long) (v - 9.223372036854776E18d)) - Long.MIN_VALUE);
        }
        return 0L;
    }
