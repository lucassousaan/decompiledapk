    ...
    */
    public android.graphics.Typeface createFromFontInfo(android.content.Context r12, android.os.CancellationSignal r13, androidx.core.provider.FontsContractCompat.FontInfo[] r14, int r15) {
        ...
        L_0x0009:
            ...
            android.net.Uri r8 = r7.getUri()     // Catch: IOException -> 0x0063, Exception -> 0x0091
            java.lang.String r9 = "r"
            android.os.ParcelFileDescriptor r8 = r1.openFileDescriptor(r8, r9, r13)     // Catch: IOException -> 0x0063, Exception -> 0x0091
            if (r8 != 0) goto L_0x0020
            if (r8 == 0) goto L_0x001f
            r8.close()     // Catch: IOException -> 0x0063, Exception -> 0x0091
        L_0x001f:
            goto L_0x0064
        L_0x0020:
        ...
        L_0x005e:
            r9 = move-exception
            r6.addSuppressed(r9)     // Catch: IOException -> 0x0063, Exception -> 0x0091
        L_0x0062:
            throw r6     // Catch: IOException -> 0x0063, Exception -> 0x0091
        L_0x0063:
            r6 = move-exception
        L_0x0064:
            int r5 = r5 + 1
