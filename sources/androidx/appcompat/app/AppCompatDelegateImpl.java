    ...
    public View createView(View parent, String name, Context context, AttributeSet attrs) {
        ...
        if (z) {
            ...
            if (this.mLayoutIncludeDetector.detect(attrs)) {
                inheritContext = true;
            } else if (!(attrs instanceof XmlPullParser)) {
                inheritContext = shouldInheritContext((ViewParent) parent);
            } else if (((XmlPullParser) attrs).getDepth() > 1) {
                inheritContext = true;
            }
        }
        return this.mAppCompatViewInflater.createView(parent, name, context, attrs, inheritContext, z, true, VectorEnabledTintResources.shouldBeUsed());
    }
