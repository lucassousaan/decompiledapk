...
public class Oscillator {
    ...
    double getP(double time) {
        ...
        double p = this.mArea[index2 - 1] + ((fArr[index2 - 1] - (dArr[index2 - 1] * m)) * (time2 - dArr[index2 - 1])) + ((((time2 * time2) - (dArr[index2 - 1] * dArr[index2 - 1])) * m) / 2.0d);
        return p;
    }
    ...
    double getDP(double time) {
        ...
        double[] dArr = this.mPosition;
        double m = (fArr[index2] - fArr[index2 - 1]) / (dArr[index2] - dArr[index2 - 1]);
        double p = (m * time2) + (fArr[index2 - 1] - (dArr[index2 - 1] * m));
        return p;
    }
